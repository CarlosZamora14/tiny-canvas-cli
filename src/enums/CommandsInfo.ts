enum CommandsInfo {
  ...
  ROTATE = `'rot <n>' rotates the cursor's current direction n times counterclockwise. If no second argument is provided, the cursor will rotate once.`,
  ROTATE_CLOCKWISE = `'rotc <n>' rotates the cursor's current direction n times clockwise. If no second argument is provided, the cursor will rotate once.`,
